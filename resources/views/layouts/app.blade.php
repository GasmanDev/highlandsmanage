...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>HIGHLANDS MANAGES</title>
        <!-- Favicon -->
        <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('black') }}/img/apple-icon.png">
        <link rel="icon" type="image/ico" href="{{ asset('black') }}/img/side_logo.png">
        <!-- Fonts -->
        <link href="https://fonts.googleapis.com/css2?family=K2D:wght@200;300;400;600;700;800&display=swap" rel="stylesheet">
            ...
            <div class="dropdown show-dropdown">
                ...
                <li class="adjustments-line">
                    ...
                    <div class="badge-colors text-center">
                        <span class="badge filter badge-primary active" data-color="red"></span>
